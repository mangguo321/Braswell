...
TempRamInitStack:
    ...
    DD  PcdGet32 (PcdCpuMicrocodePatchAddress)
  
ProtectedModeEntryPoint ENDP

;
; FSP Temp RAM Initialization Parameters
;
align 16
PUBLIC PcdGet32 (PcdCpuMicrocodePatchAddress)
PcdGet32 (PcdCpuMicrocodePatchAddress) DD 0
PUBLIC PcdGet32 (PcdCpuMicrocodePatchRegionSize)
PcdGet32 (PcdCpuMicrocodePatchRegionSize) DD 0
PUBLIC PcdGet32 (PcdFlashCodeCacheAddress)
PcdGet32 (PcdFlashCodeCacheAddress) DD 0
PUBLIC PcdGet32 (PcdFlashCodeCacheSize)
PcdGet32 (PcdFlashCodeCacheSize) DD 0
