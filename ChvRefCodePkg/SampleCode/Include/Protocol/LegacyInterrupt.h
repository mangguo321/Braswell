...
/**
  ...
  @param[in]  NumberPirsq           The number of PIRQs that are supported.
...
/**
  ...
  @param[in]  This                  The Protocol instance pointer.
  @param[in]  Bus                   The PCI Bus.
  @param[in]  Device                The PCI Device.
  @param[in]  Function              The PCI Function.
...
/**
  ...
  @param[in]  PirqData              The data read.
