...
class PlatformAutoGen(AutoGen):
    ...
    def CollectPlatformDynamicPcds(self):
        ...
        for F in self.Platform.Modules.keys():
            ...
            for PcdFromModule in M.ModulePcdList + M.LibraryPcdList:
                ...
                if PcdFromModule.Type in GenC.gDynamicPcd or PcdFromModule.Type in GenC.gDynamicExPcd:
                    ...
                    if PcdFromModule.Phase == 'PEI' and PcdFromModule.Type in [TAB_PCDS_DYNAMIC_VPD, TAB_PCDS_DYNAMIC_EX_VPD]:
                        if PcdFromModule not in self._PEIVPDPcdList_:
                            self._PEIVPDPcdList_.append(PcdFromModule)
                        else:
                            Index = self._PEIVPDPcdList_.index(PcdFromModule)
                            self._PEIVPDPcdList_[Index] = PcdFromModule
        ...
        for InfName in FdfModuleList:
            if InfName not in DscModuleList:
                ...
                for PcdFromModule in ModulePcdList:
                    ...
                    if PcdFromModule.Phase == "PEI" and PcdFromModule.Type in GenC.gDynamicExPcd:
                        if PcdFromModule not in self._PEIVPDPcdList_:
                            self._PEIVPDPcdList_.append(PcdFromModule)
                        else:
                            Index = self._PEIVPDPcdList_.index(PcdFromModule)
        ...
        if (self.Workspace.ArchList[-1] == self.Arch):
            ...
            # add the additional PEI phase VPD PCD which not in the PlatformPcds
            FullPcdDict = self.Platform.Pcds
            for pcd in self._PEIVPDPcdList_:
                if (pcd.TokenCName, pcd.TokenSpaceGuidCName) not in FullPcdDict:
                    FullPcdDict[(pcd.TokenCName, pcd.TokenSpaceGuidCName)] = pcd
            PlatformPcds = FullPcdDict.keys()
            PlatformPcds.sort()
            #
            # Add VPD type PCD into VpdFile and determine whether the VPD PCD need to be fixed up.
            #
            for PcdKey in PlatformPcds:
                Pcd = FullPcdDict[PcdKey]
            ...
            for DscPcd in PlatformPcds:
                DscPcdEntry = FullPcdDict[DscPcd]
...
class ModuleAutoGen(AutoGen):
    ...
    # Get teh tiano core user extension, it is contain dependent library.
